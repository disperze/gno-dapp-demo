  ...
  return (
    <Stack direction={'row'} spacing={6} display={{ base: 'none', md: 'inline-flex' }}>
      <Menu>
        ...
        <MenuList>
        <MenuItem>
            <Link w="full" href="https://test3.gno.land/faucet" isExternal>Faucet <ExternalLinkIcon mx='2px' /></Link>
          </MenuItem>
          <MenuItem>
          ...
          <MenuItem>
            <Link as={ReactRouterLink} w="full" to='/verify-balance'>Verify Balance</Link>
          </MenuItem>
          {/* <MenuItem>
